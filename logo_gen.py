...
backgrounder.add_settings("remove","remove_object_with_yolo_model",model, confident_level=0.4, target_class_name = None, rgb=(255,255,255), opacity = 1)
frames = backgrounder.get_background(["dict1"],[num_frames],["remove"])
